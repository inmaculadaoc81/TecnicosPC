...
module.exports=async(req,res)=>{
  ...
  try{
    ...
    await transporter.sendMail({
      from:`"PCMadrid" <${process.env.SMTP_USER}>`,
      to:process.env.CONTACT_EMAIL||process.env.SMTP_USER,
      replyTo:email,
      subject:"Nueva consulta PCMadrid - serviciopcmadrid.com.es",
      text:`Nueva consulta PCMadrid
...
${mensaje}`
    ...
    console.error("PCMadrid SMTP error",{
